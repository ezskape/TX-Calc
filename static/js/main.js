...
class PlanCalculator {
  constructor(panel, form) {
    ...
    this.resultInterpretation = panel.querySelector(".result-interpretation");
  ...
  showResults() {
    ...
    this.resultInterpretation?.classList.remove("is-hidden");
  ...
  hideResults() {
    ...
    this.resultInterpretation?.classList.add("is-hidden");
...
function setupTouCalculator() {
  ...
  const resultInterpretation = panel.querySelector(".result-interpretation");
  ...
  const hideResults = () => {
    ...
    resultInterpretation?.classList.add("is-hidden");
  ...
  const showResults = () => {
    ...
    resultInterpretation?.classList.remove("is-hidden");
